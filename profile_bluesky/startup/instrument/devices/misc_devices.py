...
shutter = EpicsSignal('TXRD:RIO.DO00', name='FastShutter')
I1 = EpicsSignalRO('TXRD:RIO.AI2', name='I1')
I0 = EpicsSignalRO('TXRD:RIO.AI1', name='I0')

lrf = EpicsSignalRO('TXRD:RIO.AI0', name='lrf')
...
filter1 = EpicsSignal('TXRD:RIO.AO1', name='filter1') # high (4.9V) = filter out
filter2 = EpicsSignal('TXRD:RIO.AO2', name='filter2') 
filter3 = EpicsSignal('TXRD:RIO.AO3', name='filter3') 
filter4 = EpicsSignal('TXRD:RIO.AO4', name='filter4') 

# class FilterBox(Device):
#     filter1 = Cpt(EpicsSignal, 'TXRD:RIO.AO1')
#     filter2 = Cpt(EpicsSignal, 'TXRD:RIO.AO2')
#     filter3 = Cpt(EpicsSignal, 'TXRD:RIO.AO3')
#     filter4 = Cpt(EpicsSignal, 'TXRD:RIO.AO4')
