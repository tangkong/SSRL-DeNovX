...
def csv_factory(name, start_doc):
    serializer = sc.Serializer( 
        '/bluedata/b_mehta/export_DeNovX/csv/', file_prefix='Scan{start[scan_id]}-' )
...
def tiff_factory(name, start_doc):
    serializer = st.Serializer( 
        '/bluedata/b_mehta/export_DeNovX/tiff/', file_prefix='Scan{start[scan_id]}-')
...
def meta_factory(name, start_doc):
    serializer = sj.Serializer( 
        '/bluedata/b_mehta/export_DeNovX/meta/', file_prefix='Scan{start[scan_id]}-' )
